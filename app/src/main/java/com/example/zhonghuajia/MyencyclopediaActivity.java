...
public class MyencyclopediaActivity extends BaseActivity {
    ...
    private void initPlants(){
        for(int i = 0; i < 2; i++){
            Plant apple = new Plant("Apple", R.drawable.apple_pic);
            plantList.add(apple);
            Plant banana = new Plant("Banana", R.drawable.banana_pic);
            plantList.add(banana);
            Plant orange = new Plant("Orange", R.drawable.orange_pic);
            plantList.add(orange);
            Plant watermelon = new Plant("Watermelon", R.drawable.watermelon_pic);
            plantList.add(watermelon);
            Plant pear = new Plant("Pear", R.drawable.pear_pic);
            plantList.add(pear);
            Plant grape = new Plant("Grape", R.drawable.grape_pic);
            plantList.add(grape);
            Plant pineapple = new Plant("Pineapple", R.drawable.pineapple_pic);
            plantList.add(pineapple);
            Plant strawberry = new Plant("Strawberry", R.drawable.strawberry_pic);
            plantList.add(strawberry);
            Plant cherry = new Plant("Cheery", R.drawable.cheery_pic);
            plantList.add(cherry);
            Plant mango = new Plant("Mango", R.drawable.mango_pic);
            plantList.add(mango);
        }
    }
}
